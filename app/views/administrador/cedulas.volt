...
<div class="white-bg dashboard-header col-md-5 col-md-offset-1">
    ...
    <a href="../Plantillas_Excel/PlantillaUsuarios.csv" target="_blank" class="btn btn-primary form-control"><i class="fas fa-file-excel"></i> Descargar plantilla</a>
    <br>
</div>

<div class="white-bg dashboard-header col-md-5  ">
    <form enctype="multipart/form-data" method="POST" action="{{url('administrador/cedulas')}}"  name="cargarBase" >
