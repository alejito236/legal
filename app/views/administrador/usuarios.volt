...
<div class="row col-md-12">
	<form action="{{url('administrador/usuarios')}}" method="POST">
		<div class="col-md-5">
	...
	<div class="col-md-2">
		<button class="btn btn-primary form-control" data-toggle="modal" data-target="#myModal5">
											...
											<tr class="gradeX">
												...
												<td class="text-center">
													<form action="{{url('administrador/usuarios')}}" method="POST">
														...
														<input type="hidden" name="campana" value="{{ item.campanaId }}">
														...
														<button type="submit" id="botonEditar" class="botonEditar btn btn-warning" onlick({{item.cedula}});>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" {% if dato is defined %} action="{{url('administrador/editUsuario')}}" {% else %} action="{{url('administrador/nuevoUsuario')}}" {% endif %}>
					<div class="row">
						<div class="col-md-4">
							<div class="col-md-3">
							...
							<div class="col-md-12">
								<select required name="campana" id="campana" class="form-control m-b">
									{% for item in campanas %}
										<option value="{{item.campanaId}}" {% if dato['campana'] is defined and dato['campana'] is item.campanaId %} selected {% endif %}>{{item.nombre}}
										</option>
									{% endfor %}
								</select>
							</div>
						...
						<div class="col-md-6">
							...
							<div class="col-md-12">
								<select required name="rol" id="rol1" class="form-control m-b">
									...
									{% for item in roles %}
										<option value="{{item.rolId}}" {% if dato['rol'] is defined and dato['rol'] is item.rolId %} selected {% endif %}>{{item.nombre}}
										</option>
									{% endfor %}
								</select>
							</div>
...
window.location ='{{ url("administrador/usuarios") }}';
});
