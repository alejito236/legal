		...
		<div class="col-md-12">
			<table class="table table-bordered table-striped dataTables-example">
				...
				<tbody>
					{% for item in data %}
					<tr>
						<form action="{{url('administrador/valor')}}" class="formu" method="POST">
							<td>
								{{item.num}}
							</td>
							<td>
	  ...
	  <div class="modal-content">
		...
		<div class="modal-body">
			<div class="white-bg dashboard-header col-md-10 col-md-offset-1">
				...
				<a href="{{url('administrador/plantillaValorSoat')}}" target="_blank" class="btn btn-primary form-control"><i class="fas fa-file-excel"></i> Descargar plantilla</a>
			</div>
			<div class="white-bg dashboard-header col-md-10">
				<form enctype="multipart/form-data" method="POST" action="{{url('administrador/cargarValor')}}"  name="cargarBase" >
