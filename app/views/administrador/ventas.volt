...
<div class="row col-md-12">
    <form action="{{url('administrador/ventas')}}" method="POST">
        <div class="col-md-5">
...
<div class="col-md-12">
    <h1>Ventas Soat <i class="fas fa-file"></i></h1>
    <hr>
</div>
...
<div class="col-md-12">
				...
				<table class="table table-striped table-bordered no-margins">
					...
					<tr>
						...
						<td class="text-center">
							<form action="{{url('administrador/ventas')}}" id="anular" method="POST">
	...
	<div class="col-md-12">
		<h1>Ventas Tarjetas <i class="fas fa-file"></i></h1>
		<hr>
	</div>
	...
	{% if ventaKO is defined %}
		...
		<div class="col-md-12">
			<div class=" col-md-12 alert alert-danger alert-dismissable">
				<button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
				<i class="fas fa-ban"></i> La cedula <b>{{ventaKO}}</b> no está en Ventas.
			</div>
		</div>
	...
	<div class="col-md-12">
		<h1>Ventas FAMISANAR <i class="fas fa-file"></i></h1>
		<hr>
	</div>
	...
	<div class="col-md-12">
		<h1>Ventas Todo Riesgo <i class="fas fa-file"></i></h1>
		<hr>
	</div>
				...
				<div class="ibox-content table-responsive" style="padding:0!important;">
					<table class="table table-striped table-bordered no-margins">
						<thead>
							...
							<th>Nombre Cliente</th>
							<th>Cedula Cliente</th>
							<th>Fecha Vencimiento Poliza</th>
