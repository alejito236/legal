        ...
        <div class="col-lg-3">
            <div class="ibox">
                <div class="ibox-content">
                    ...
                    <h2 class="text-navy">
                        <i class="fas fa-dollar-sign"></i> {{cantidadTunja.ventasTunja}}
                    </h2>
                </div>
            </div>
        </div>
            ...
            <div class="ibox">
                <div class="ibox-content ">
                    ...
                    <h2 class="text-success">
                        <i class="fas fa-sync-alt"></i> {{cantidadTunja.renovacionesTunja}}
            ...
            <div class="ibox">
                <div class="ibox-content ">
                    ...
                    <h2 class="text-warning">
                        <i class="fas fa-phone"></i> {{cantidadTunja.contactadosTunja}}
                    </h2>
                </div>
            </div>
        </div>
            ...
            <div class="ibox">
                <div class="ibox-content ">
                    ...
                    <h2 class="text-danger">
                        <i class="fas fa-chart-line"></i> {{cantidadTunja.totalBase}}
                    </h2>
                </div>
            </div>
        </div>
                ...
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li><form action="{{url('SOATcoordinador/ReporteVentasAsesorTunja')}}" target="_blank" method="POST">
            ...
            <div class="ibox ">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li><form action="{{url('SOATcoordinador/ReporteRenovacionesTunja')}}" target="_blank" method="POST">
                                <input type="hidden" name="fechaInicio" value="{{fechaInicial}}" class="form-control">
                                <input type="hidden" name="fechaFinal" value="{{fechaFinal}}">
                                <button class="btn btn-primary form-control">Exportar</button>
                            </form>
