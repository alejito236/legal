...
<div class="col-md-12">
    <h1>Renovaciones <i class="fas fa-file-signature"></i></h1>
    <hr>
</div>
<div class="col-md-12">
    <form action="{{url('SOATcoordinador/renovaciones')}}" method="POST">
        <div class="col-md-4">
				...
				<table class="table table-striped table-bordered no-margins">
					...
					<tr>
						...
						<td class="text-center">
							<form action="{{url('SOATcoordinador/renovaciones')}}" id="anular" method="POST">
