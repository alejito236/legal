...
<div class="col-lg-12">
<form action="{{url('SOATcoordinador/ciudadbucaramanga')}}" method="POST">
    ...
    <div class="col-lg-3">
        <div class="ibox">
            <div class="ibox-content">
                ...
                <h2 class="text-navy">
                    <i class="fas fa-dollar-sign"></i> {{cantidadBucaramanga.ventasBucaramanga}}
                </h2>
            </div>
        </div>
    </div>
        ...
        <div class="ibox">
            <div class="ibox-content ">
                ...
                <h2 class="text-success">
                    <i class="fas fa-sync-alt"></i> {{cantidadBucaramanga.renovacionesBucaramanga}}
        ...
        <div class="ibox">
            <div class="ibox-content ">
                ...
                <h2 class="text-warning">
                    <i class="fas fa-phone"></i> {{cantidadBucaramanga.contactadosBucaramanga}}
                </h2>
            </div>
        </div>
    </div>
        ...
        <div class="ibox">
            <div class="ibox-content ">
                ...
                <h2 class="text-danger">
                    <i class="fas fa-chart-line"></i> {{cantidadBucaramanga.total}}
                </h2>
            </div>
        </div>
    </div>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Ventas en Bucaramanga</h5>
                    <div class="ibox-tools">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="fa fa-wrench"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-user">
                            <li><form action="{{url('SOATcoordinador/ReporteVentasAsesorBucaramanga')}}" target="_blank" method="POST">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Renovaciones en Bucaramanga</h5>
                    <div class="ibox-tools">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="fa fa-wrench"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-user">
                            <li><form action="{{url('SOATcoordinador/ReporteRenovacionesBucaramanga')}}" target="_blank" method="POST">
                                <input type="hidden" name="fechaInicio" value="{{fechaInicial}}" class="form-control">
                                <input type="hidden" name="fechaFinal" value="{{fechaFinal}}">
                                <button class="btn btn-primary form-control">Exportar</button>
                            </form>
