...
<div class="col-lg-12">
<form action="{{url('SOATcoordinador/ciudadcali')}}" method="POST">
    ...
    <div class="col-lg-3">
        <div class="ibox">
            <div class="ibox-content">
                ...
                <h2 class="text-navy">
                    <i class="fas fa-dollar-sign"></i> {{cantidadCali.ventasCali}}
                </h2>
            </div>
        </div>
    </div>
        ...
        <div class="ibox">
            <div class="ibox-content ">
                ...
                <h2 class="text-success">
                    <i class="fas fa-sync-alt"></i> {{cantidadCali.renovacionesCali}}
        ...
        <div class="ibox">
            <div class="ibox-content ">
                ...
                <h2 class="text-warning">
                    <i class="fas fa-phone"></i> {{cantidadCali.contactadosCali}}
                </h2>
            </div>
        </div>
    </div>
        ...
        <div class="ibox">
            <div class="ibox-content ">
                ...
                <h2 class="text-danger">
                    <i class="fas fa-chart-line"></i> {{cantidadCali.total}}
                </h2>
            </div>
        </div>
    </div>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Ventas en Cali</h5>
                    <div class="ibox-tools">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="fa fa-wrench"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-user">
                            <li><form action="{{url('SOATcoordinador/ReporteVentasAsesorCali')}}" target="_blank" method="POST">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Renovaciones en Cali</h5>
                    <div class="ibox-tools">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="fa fa-wrench"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-user">
                            <li><form action="{{url('SOATcoordinador/ReporteRenovacionesCali')}}" target="_blank" method="POST">
                                <input type="hidden" name="fechaInicio" value="{{fechaInicial}}" class="form-control">
                                <input type="hidden" name="fechaFinal" value="{{fechaFinal}}">
                                <button class="btn btn-primary form-control">Exportar</button>
                            </form>
