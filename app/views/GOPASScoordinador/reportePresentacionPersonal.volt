<?php
    ...
    header("content-disposition: attachment;filename=Reporte de presentacion personal .xls");
        ...
        <tbody>
            {% for item in data %}
                <tr>
                    ...
                    <td>{{item.calificacionPresentacionPersonal}}</td>
                </tr>
            {% endfor %}
        </tbody>
    </table>
