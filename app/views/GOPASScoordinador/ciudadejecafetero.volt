...
</style><div class="col-lg-3" style="margin: 2% 0" >
    <div class="ibox">
...
<div class="col-lg-12">
    <form action="{{url('SOATcoordinador/ciudadibague')}}" method="POST">
        ...
        <div class="col-lg-3">
            <div class="ibox">
                <div class="ibox-content">
                    ...
                    <h2 class="text-navy">
                        <i class="fas fa-dollar-sign"></i> {{cantidadEjecafetero.ventasEjecafetero}}
                    </h2>
                </div>
            </div>
        </div>
            ...
            <div class="ibox">
                <div class="ibox-content ">
                    ...
                    <h2 class="text-success">
                        <i class="fas fa-sync-alt"></i> {{cantidadEjecafetero.renovacionesEjecafetero}}
            ...
            <div class="ibox">
                <div class="ibox-content ">
                    ...
                    <h2 class="text-warning">
                        <i class="fas fa-phone"></i> {{cantidadEjecafetero.contactadosEjecafetero}}
                    </h2>
                </div>
            </div>
        </div>
            ...
            <div class="ibox">
                <div class="ibox-content ">
                    ...
                    <h2 class="text-danger">
                        <i class="fas fa-chart-line"></i> {{cantidadEjecafetero.total}}
                    </h2>
                </div>
            </div>
        </div>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Ventas en el Eje Cafetero</h5>
                    <div class="ibox-tools">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="fa fa-wrench"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-user">
                            <li><form action="{{url('SOATcoordinador/ReporteVentasAsesorEjecafetero')}}" target="_blank" method="POST">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Renovaciones en el Eje Cafetero</h5>
                    <div class="ibox-tools">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="fa fa-wrench"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-user">
                            <li><form action="{{url('SOATcoordinador/ReporteRenovacionesEjecafetero')}}" target="_blank" method="POST">
                                <input type="hidden" name="fechaInicio" value="{{fechaInicial}}" class="form-control">
                                <input type="hidden" name="fechaFinal" value="{{fechaFinal}}">
                                <button class="btn btn-primary form-control">Exportar</button>
                            </form>
