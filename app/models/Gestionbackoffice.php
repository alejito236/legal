...
class Gestionbackoffice extends \Phalcon\Mvc\Model
{
    ...
    public function getListadoGestion($ciudades,$productos){
        $consulta1 = "SELECT tv.tipoventa_id, v.ventaid, ge.gestionexpedidorid, ga.gestionAsignacionid, gm.gestionmotorizadoid,
        ...
        FROM tipoventa tv, venta v, gestionexpedidor ge, gestionAsignacion ga, gestionbackoffice gb, gestionmotorizado gm,
        ...
        and ga.gestionAsignacionid = gb.gestionAsignacionId and v.ciudadid = c.ciudadid and v.productoid = p.productoid
        and gb.estadoBackoffice = eb.estadoid and gb.estadoCierre = ec.estadoid and ga.usuarioMensajeroId = u.usuarioid
        and (ec.estadoId is null or ec.estadoid = 23) and gm.gestionAsignacionid = ga.gestionAsignacionid 
        ...
        $consulta2 = "SELECT tv.tipoventa_id, v.ventaid, ge.gestionexpedidorid, ga.gestionAsignacionid, gm.gestionmotorizadoid,
        c.ciudadid, c.nombre nombreCiudad, p.productoid, p.nombre nombreProducto, tv.cedulacliente, v.franjaHoraria,
        ...
        FROM tipoventa tv, venta v, gestionexpedidor ge, gestionAsignacion ga, gestionmotorizado gm,
        ciudad c, producto p, usuario u, estado e
        WHERE tv.tipoventa_id = v.tipoventa_id and v.ventaid = ge.ventaid and ge.gestionexpedidorid = ga.gestionexpedidorid
        and gm.gestionAsignacionid  = ga.gestionAsignacionid
        and v.ciudadid = c.ciudadid and v.productoid = p.productoid and ga.usuarioMensajeroId = u.usuarioid
        and ga.gestionAsignacionid not in (select gestionAsignacionid from gestionbackoffice) and gm.estadoMotorizado = e.estadoid
    ...
    public function getGestionBack($gestionAsignacionid){
        $consulta = "SELECT tv.tipoventa_id, v.ventaid, ge.gestionexpedidorid, ga.gestionAsignacionid, cl.cedulacliente, tv.placa,
        ...
        from tipoventa tv, venta v, gestionexpedidor ge, gestionAsignacion ga, cliente cl, ciudad c, barrio b, producto p
        where tv.tipoventa_id = v.tipoventa_id and v.ventaid = ge.ventaid and ge.gestionexpedidorid = ga.gestionexpedidorid 
        and tv.cedulacliente = cl.cedulacliente and v.ciudadid = c.ciudadid and v.barrioid = b.barrioid 
        and v.productoid = p.productoid and ga.gestionAsignacionid = $gestionAsignacionid";
        $prepare = $this->getDi()->getShared("db")->prepare($consulta);
        $prepare->execute();
        return $prepare;
    }
    ...
    public function getAnuladosBack($fechaInicio, $fechaFin){
        $consulta = "SELECT tv.tipoventa_id, v.ventaid, ge.gestionexpedidorid, ga.gestionAsignacionid, gm.gestionmotorizadoid,
        c.ciudadid, c.nombre nombreCiudad, p.productoid, p.nombre nombreProducto, tv.cedulacliente, v.franjaHoraria,
        tv.placa, u.usuarioid, u.nombre nombreMoto, em.estadoid, em.nombre nombreEstadoMoto, v.fechaEntrega,
        ...
        and ga.gestionAsignacionid = gb.gestionAsignacionId and v.ciudadid = c.ciudadid and v.productoid = p.productoid
        and gb.estadoBackoffice = eb.estadoid and gb.estadoCierre = ec.estadoid and ga.usuarioMensajeroId = u.usuarioid
        and (ec.estadoId is not null and ec.estadoid != 23) and gm.gestionAsignacionid = ga.gestionAsignacionid 
